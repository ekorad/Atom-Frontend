...
export class UserRoleService {
  ...
  addNew(role: UserRole): Observable<unknown> {
    return this.http.post('http://192.168.1.194:8080/users/roles/add', role);
  }
  ...
  editRole(roleName: string, role: UserRole): Observable<unknown> {
    ...
    return this.http.put('http://192.168.1.194:8080/users/roles/update', role, options);
  }
  ...
  deleteRoles(roleNames: string[]): Observable<unknown> {
    ...
    return this.http.delete('http://192.168.1.194:8080/users/roles/remove', options);
  }
